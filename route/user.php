...
include _include(VNBB_PATH.'xn_send_mail.func.php');
...
if(empty($action)) {
	...
	//message(0, jump('Thoát thành công', './', 1));
...
// reset password first step
	...
	!$conf['user_resetpw_on'] AND message(-1, 'Chức năng lấy lại mật khẩu chưa được kích hoạt!');
